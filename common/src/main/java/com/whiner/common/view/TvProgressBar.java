...
import com.whiner.common.databinding.LayoutTvProgressBarBinding;
...
public class TvProgressBar extends ConstraintLayout implements TvSeekBar.OnTvSeekBarListener, View.OnFocusChangeListener {
    ...
    private void init() {
        ...
        binding.vStart.setOnFocusChangeListener(this);
        binding.vEnd.setOnFocusChangeListener(this);
    ...
    private void actionFocus(int view_id) {
        ...
        } else if (view_id == R.id.v_start) {
            next_view_id = getNextFocusLeftId();
        } else if (view_id == R.id.v_end) {
